 ...
 * Slug: car-repair-blocks/blog-right-sidebar
 * Categories: car-repair-blocks, blog-right-sidebar
 */
?>
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"car-repair-blocks","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->