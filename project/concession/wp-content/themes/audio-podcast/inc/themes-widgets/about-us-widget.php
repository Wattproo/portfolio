...
class Audio_Podcast_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Audio_Podcast_Lite_About_Widget',
			__('VW About us', 'audio-podcast'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'audio-podcast' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','audio-podcast'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','audio-podcast'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','audio-podcast'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','audio-podcast'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','audio-podcast'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','audio-podcast'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function audio_podcast_about_custom_load_widget() {
	register_widget( 'Audio_Podcast_Lite_About_Widget' );
}
add_action( 'widgets_init', 'audio_podcast_about_custom_load_widget' );