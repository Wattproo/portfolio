 ...
 * Posts pagination.
 */
if ( ! function_exists( 'audio_podcast_blog_posts_pagination' ) ) {
	function audio_podcast_blog_posts_pagination() {
		$pagination_type = get_theme_mod( 'audio_podcast_blog_pagination_type', 'blog-page-numbers' );
