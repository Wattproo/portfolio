...
?>
    ...
    <footer role="contentinfo">
        ...
        <?php }?> 
        <?php if (get_theme_mod('audio_podcast_copyright_hide_show', true)) {?>
            <div id="footer-2" class="pt-3 pb-3 text-center">
              	<div class="copyright container">
                    ...
                    <?php endif; ?>
                    <?php if( get_theme_mod( 'audio_podcast_hide_show_scroll',true) == 1 || get_theme_mod( 'audio_podcast_resp_scroll_top_hide_show',true) == 1) { ?>
